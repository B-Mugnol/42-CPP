...
/*   Updated: 2023/08/02 09:27:02 by bmugnol-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "FragTrap.hpp"

const unsigned int FragTrap::baseHitPoints = 100;
const unsigned int FragTrap::baseEnergyPoints = 100;
const unsigned int FragTrap::baseAttackDamage = 30;

FragTrap::FragTrap(void) : ClapTrap()
{
	std::cout << "ClapTrap '" << this->getName() << "' has evolved to FragTrap!" << std::endl;
	this->setHitPoints(baseHitPoints);
	this->setEnergyPoints(baseEnergyPoints);
	this->setAttackDamage(baseAttackDamage);
	return;
}
